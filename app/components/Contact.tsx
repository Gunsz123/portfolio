...
export const Contact = () => {
  ...
  return (
    <motion.section
      ...
      <h1
        className="2xl:text-5xl lg:text-4xl md:text-4xl text-3xl text-violet-800 font-bold w-fit inline-block mr-4 anim9 items-center justify-center 2xl:ml-[51rem] md:ml-[30rem] md:mt-[4 rem] md:w-[20rem] ml-[7.5rem] mt-[2rem]"
