...
export const TracingBeam = ({
  ...
  return (
    <motion.div ref={ref} className={cn("relative w-full mx-auto h-full", className)}>
      <div className="absolute  2xl:left-[1rem] top-3">
        <motion.div
          transition={{
            duration: 0.2,
            delay: 0.5,
          ...
          className="ml-[27px] h-4 w-4 rounded-full border border-netural-200 shadow-sm lg:flex items-center justify-center hidden">
          <motion.div
            transition={{
              duration: 0.2,
              delay: 0.5,
